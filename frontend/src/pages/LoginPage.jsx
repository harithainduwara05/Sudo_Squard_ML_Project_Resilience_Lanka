        ...
        <div className="relative z-10 px-16 max-w-lg">
          ...
          >
            ...
            <p style={{ color: '#94a3b8', fontSize: '1.1rem', marginTop: '16px', lineHeight: 1.6 }}>
              Real-Time Flood Risk Analytics<br />& Early Warning System
            </p>
            ...
            <p style={{ color: '#64748b', fontSize: '0.85rem', lineHeight: 1.7 }}>
              Protecting communities with advanced machine learning models and real-time environmental monitoring.
            </p>
          </motion.div>

          {/* Floating Stats */}
          <FloatingStat value="98.5%" label="Model Accuracy" delay={0.4} top="12%" right="10%" />
          <FloatingStat value="25" label="Districts Covered" delay={0.7} top="55%" right="5%" />
          <FloatingStat value="24/7" label="Live Monitoring" delay={1.0} bottom="18%" left="60%" top="auto" />
        </div>
      </div>
        ...
        >
          ...
          <div style={{
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Email */}
              <div>
                <label htmlFor="login-email" style={{ color: '#94a3b8', fontSize: '0.8rem', fontWeight: 500, display: 'block', marginBottom: '6px', letterSpacing: '0.5px', textTransform: 'uppercase' }}>
                  Email Address
                </label>
                <input
                  id="login-email"
                  ...
                  onBlur={e => { e.target.style.borderColor = 'rgba(56, 189, 248, 0.1)'; e.target.style.boxShadow = 'none'; }}
                />
              </div>

              {/* Password */}
              <div>
                <label htmlFor="login-password" style={{ color: '#94a3b8', fontSize: '0.8rem', fontWeight: 500, display: 'block', marginBottom: '6px', letterSpacing: '0.5px', textTransform: 'uppercase' }}>
                  Password
                </label>
            ...
            {/* Register Link */}
            <p style={{ textAlign: 'center', marginTop: '28px', color: '#64748b', fontSize: '0.85rem' }}>
